...
export const Footer = () => {
  return (
    <footer className="w-full border-t border-border/60 bg-card/60 backdrop-blur-md supports-[backdrop-filter]:bg-card/40">
      ...
      <div className="mx-auto max-w-6xl px-3 sm:px-4 py-5 sm:py-7 flex flex-col md:flex-row items-center md:items-center justify-between gap-4 sm:gap-6">
        {/* Created by */}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
          <a
            ...
            className="ai-rounded-lg px-3 sm:px-4 py-2 border border-border/70 bg-background/50 hover:bg-primary/10 transition-colors inline-flex items-center gap-2 ai-glass ai-card-glow w-full sm:w-auto justify-center sm:justify-start"
            target="_blank" rel="noreferrer"
          >
            <Mail className="w-4 h-4 text-primary" />
            <span className="text-xs sm:text-sm">mehvishsheikh689@gmail.com</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-xs sm:text-sm">github: @mehvishsheikh</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-xs sm:text-sm">linkedin: @mehvish-sheikh</span>
          </a>
        </div>
      </div>
    </footer>
